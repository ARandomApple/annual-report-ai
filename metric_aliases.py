    ...
    return [
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("Total Net Sales"),
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("销售成本"),
                MetricAlias.from_pattern("Cost of revenues"),
                MetricAlias.from_pattern("Cost of Sales"),
                MetricAlias.from_pattern("Total Cost of Sales"),
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("除所得税前利润"),
                MetricAlias.from_pattern("Profit before income tax"),
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("年度利润"),
                MetricAlias.from_pattern("Profit for the year"),
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("经营活动所得现金净额"),
                ...
                MetricAlias.from_pattern("Net cash flows generated from operating activities"),
                MetricAlias.from_pattern("Operating cash flow"),
                MetricAlias.from_pattern("Cash flows from operating activities"),
                MetricAlias.from_pattern("Cash generated by operating activities"),
            ],
        ),
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("投资活动所用现金净额"),
                ...
                MetricAlias.from_pattern("Net cash flows used in investing activities"),
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("融资活动所得现金净额"),
                MetricAlias.from_pattern("融资活动所用现金净额"),
                ...
                MetricAlias.from_pattern("Net cash flows used in financing activities"),
        ...
        CanonicalMetric(
            ...
            aliases=[
                ...
                MetricAlias.from_pattern("购买物业、厂房及设备、土地使用权及无形资产"),
